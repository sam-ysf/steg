...
namespace steg {
    ...
    public:
        ...
        static BlockDecoder* create(const char* key, const char* initvec);
    ...
    private:
        ...
        bool decode_digest(Tout& out,
                           char* buff,
                           std::enable_if_t<vvb64, std::size_t> base64Size)
        {
            ...
            if (size == 0) {
                return false; // Message is empty or incomplete
            }
